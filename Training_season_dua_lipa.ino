...
const LyricLine SONG1_LYRICS[] PROGMEM = {
  { 0,     "(You should know I)" },
  { 3000,  "I need someone to hold me close" },
  { 6500,  "deeper than I've ever known" },
  { 10000, "Whose love feels like a rodeo" },
  { 13500, "knows just how to take control" },
  { 17000, "When I'm vulnerable" },
  { 20500, "he's straight-talking to my soul" },
  { 24000, "Conversation overload" },
  { 27500, "got me feeling vertigo" },
  { 31000, "Are you somebody who can go there?" },
  { 34500, "'Cause I don't wanna have to show ya" },
};
...
Song songList[] = {
  { "Training Season", SONG1_LYRICS, SONG1_LYRICS_LEN, 38000UL },
};
